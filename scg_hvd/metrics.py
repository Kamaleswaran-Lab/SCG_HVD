# Metrics are computed from raw predictions, not from the original normalize-then-multiply path.
"""Why this module exists rather than reusing what produced the published tables.

The original pipeline normalized each confusion matrix with `normalize='true'`, stored it to
